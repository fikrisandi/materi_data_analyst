...
- BigQuery syntax (date, string, array, struct)
- Case 1: NYC Taxi 2022
- Case 2: COVID Indonesia
- Case 3: Google Analytics Sample
- Cost optimization

~3 jam · materi.md + latihan/soal.md

🎯 Bonus target: Google Cloud Skill Badge "BigQuery for Data Warehousing"
